...
dat <- readMat("data_original/indices_CA_1979_2010.mat")

length(dat)
lapply(dat, dim)

## 174 stations, 32 years, lat, lon, 10 index
...
dat <- readMat("data_original/indices_temp_CA_1970_2004.mat")
...
## 46 stations, 35 years, lat, lon, 11 index
