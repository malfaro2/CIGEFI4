...
rm(list=ls())
source(file="code/1.descriptive_bimonth_temp.R")
...
#stati is a list of 9 variables, each a list of 5 bimonths, each w/ matrix(0,174,101)
...
rm(list=ls())
source(file="code/1.descriptive_bimonth_prec.R")
